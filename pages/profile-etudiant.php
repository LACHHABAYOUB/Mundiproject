		...
		<div class="main" role="main">
			...
			<section class="page-content">
				...
				$id_user=$_SESSION['login_user'];			
                 ...
                 $donnees=$req0->fetch();
				 $nom_cv=pathinfo($donnees['cv'], PATHINFO_FILENAME);
				 $nom_lm=pathinfo($donnees['lm'], PATHINFO_FILENAME);
				?>
												<ul class="info">
												<li><i class="fa fa-location-arrow"></i><span style="font-weight:bold;">Localisation : </span><a href="#"><?php if($donnees['ville']=="") echo "Aucune"; else echo $donnees['ville'].','.$donnees['pays'];?></a></li>
												<li><i class="fa fa-birthday-cake"></i><span style="font-weight:bold;">Date de naissance : </span><?php if($donnees['date_naissance']=="0000-00-00") echo "Aucune"; else echo $donnees['date_naissance'];?></li>
												<li><i class="fa entypo location"></i><span style="font-weight:bold;">Adresse : </span><?php if($donnees['adresse']=="") echo "Aucune"; else echo $donnees['adresse'];?></li>
												<li><i class="fa fa-phone"></i><span style="font-weight:bold;">Télephone : </span><?php if($donnees['telephone']=="") echo "Aucun"; else echo $donnees['telephone'];?></li>
												<li><i class="fa fa-file-pdf-o"></i><span style="font-weight:bold;">CV : </span><a href="<?php echo $donnees['cv'];?>"><?php if($donnees['cv']=="") echo "Aucun"; else echo $nom_cv;?></a></li>
												<li><i class="fa fa-file-pdf-o"></i><span style="font-weight:bold;">Lette de motivation : </span><a href="<?php echo $donnees['lm'];?>"><?php if($donnees['lm']=="") echo "Aucune"; else echo $nom_lm;?></a></li>
